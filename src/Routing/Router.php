...
class Router
{
	 ...
	 */
    private function getRegularExpression($Route)
    {
		$startDelimiter = '/^';
		$endDelimiter = '$/';
	 ...
	 */
    private function getKeywordValue($matches, $explodedUrl, $keyword)
    {
	 ...
	 */
    private function getParameterValues($matches, $explodedUrl, $parameters)
    {
		$parameterValues = [];
